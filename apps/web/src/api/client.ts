...
export const api = {
  ...
  addMessageNote: (id: string, body: string) => request<SlackMessage>(`/messages/${id}/notes`, { method: "POST", body: JSON.stringify({ body }) }),
  ...
  addTodoNote: (id: string, body: string) => request<TodoItem>(`/todos/${id}/notes`, { method: "POST", body: JSON.stringify({ body }) }),
