...
export type SlackMcpConversation = {
  id: string;
  name?: string;
...
export type KnowledgeItem = KnowledgeReference & {
  tags: string[];
  content: string;
  updatedAt: string;
};
...
export type MessageListItem = NormalizedSlackMessage & {
